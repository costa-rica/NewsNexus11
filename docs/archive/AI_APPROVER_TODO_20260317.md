...
- At the end of each phase:
  ...
  - Create a commit.
  - The commit message should refer to `docs/AI_APPROVER_TODO_20260317.md` and mention the phase completed.
...
- [ ] Commit with a message that references `docs/AI_APPROVER_TODO_20260317.md` and phase 1.
...
- [ ] Decide and implement whether unused prompt delete is hard delete or soft delete.
- [ ] Add API tests for create, copy, list, activate/deactivate, and guarded delete behavior.
- [ ] Run relevant tests for this phase.
- [ ] If tests pass, check off completed tasks in this phase.
- [ ] Commit with a message that references `docs/AI_APPROVER_TODO_20260317.md` and phase 2.

## 4. phase 3 - worker-python AI approver workflow
...
- [ ] Reuse the shared queue and job-status patterns if the workflow is long-running.
...
- [ ] Add worker-python tests for filtering, prompt lookup, response handling, and persistence behavior.
- [ ] Run relevant tests for this phase.
- [ ] If tests pass, check off completed tasks in this phase.
- [ ] Commit with a message that references `docs/AI_APPROVER_TODO_20260317.md` and phase 3.
...
- [ ] Run relevant tests for this phase.
- [ ] If tests pass, check off completed tasks in this phase.
- [ ] Commit with a message that references `docs/AI_APPROVER_TODO_20260317.md` and phase 4.
...
- [ ] Run relevant tests for this phase.
- [ ] If tests pass, check off completed tasks in this phase.
- [ ] Commit with a message that references `docs/AI_APPROVER_TODO_20260317.md` and phase 5.

## 7. phase 6 - portal prompt management page
...
- [ ] Run relevant tests for this phase.
- [ ] If tests pass, check off completed tasks in this phase.
- [ ] Commit with a message that references `docs/AI_APPROVER_TODO_20260317.md` and phase 6.

## 8. phase 7 - review table and modal
...
- [ ] Run relevant tests for this phase.
- [ ] If tests pass, check off completed tasks in this phase.
- [ ] Commit with a message that references `docs/AI_APPROVER_TODO_20260317.md` and phase 7.
...
- [ ] If tests pass, check off completed tasks in this phase.
- [ ] Commit with a message that references `docs/AI_APPROVER_TODO_20260317.md` and phase 8.
