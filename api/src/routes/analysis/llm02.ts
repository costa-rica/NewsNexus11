...
router.get("/no-article-approved-rows", authenticateToken, async (_req: Request, res: Response) => {
...
router.post("/service-login", authenticateToken, async (req: Request, res: Response) => {
...
router.post("/update-approved-status", authenticateToken, async (req: Request, res: Response) => {
